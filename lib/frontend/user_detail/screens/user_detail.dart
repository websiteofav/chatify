          ...
          listener: (context, state) {
            if (state is UserPrimaryTableLoaded) {
              ...
              BlocProvider.of<HomeBloc>(context)
                  .add(AddPrimaryDataEvent(model: model));
            } else if (state is UserPrimaryDetailsLoaded) {
              // _loadingOverlay.hide();

              BlocProvider.of<HomeBloc>(context).add(CreateSecondaryTableEvent(
                  username: _userNameEditingController.text));
            } else if (state is UserSecondaryTableLoaded) {
              _loadingOverlay.hide();
            ...
            } else if (state is UserPrimaryDetailsFaield) {
              _loadingOverlay.hide();
              CoolAlert.show(
                context: context,
                onConfirmBtnTap: () {
            ...
            } else if (state is UserSecondaryDetailsFailed) {
              _loadingOverlay.hide();
              CoolAlert.show(
                context: context,
                onConfirmBtnTap: () {
          ...
          child: BlocListener<UserDetailBloc, UserDetailState>(
            listener: (context, state) {
              if (state is UserDetailLoading) {
                ...
                BlocProvider.of<HomeBloc>(context)
                    .add(const CreatePrimaryTableEvent());
